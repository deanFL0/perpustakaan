                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('buku.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="1900" max="2099" step="1" value="2000" class="form-control" id="tahunterbit" name="tahunterbit" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="1" value="1" class="form-control" id="jumlah" name="jumlah" required>
                        </div>
                        <div class="mb-3">
